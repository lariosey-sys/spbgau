...
Динамические модели микроклимата теплицы обычно опираются на баланс энергии, энтальпии и массы. Это важно для текущей ВКР: даже если практическая реализация использует датчики и реле, физическая сущность задачи остается теплотехнической. Самарин и др. формулируют задачу имитационного моделирования оптимального управления микроклиматом сельскохозяйственного объекта через температурно-влажностный режим, тепловой баланс, влажностное состояние конструкций и энергосберегающий режим выращивания [32]. Такой подход поддерживает выбранную рамку: система должна не только включать устройства, но и формировать данные для модели поведения теплицы. Теплотехническая постановка задачи культивирования растений в искусственной среде имеет давнюю отечественную традицию: в фундаментальной монографии по управляемому культивированию камера с растениями уже описывается уравнениями теплового и влажностного баланса, а облучающие устройства, термовлагорегулирование и регулирование газовой среды рассматриваются как единый биотехнический комплекс [rozhdestvensky1980controlled]. Эта классическая рамка прямо согласуется с трактовкой теплицы как объекта тепло- и массообмена и используется далее при численном замыкании теплового баланса и интерпретации световых режимов (глава 3).
...
Давление насыщения $e_{\text{н}}(T)$ в формуле (3.1) вычислялось по температуре воздуха в боксе (а не по температуре листа), что соответствует распространенной инженерной оценке VPD по данным климатических датчиков и оговаривается как методическое допущение. Существенно уточнить и фазу, относительно которой берется насыщение: на всем периоде наблюдений температура воздуха была положительной (17,6-34,9 °C), поэтому $e_{\text{н}}(T)$ рассчитывалось над поверхностью воды - именно этому соответствуют коэффициенты формулы Тетенса (17,27 и 237,3 °C) в (3.1). Насыщение надо льдом, применимое лишь при отрицательных температурах, в данных условиях не используется, поэтому методическая неоднозначность «вода/лед» здесь не возникает. Сам диапазон благоприятной относительной влажности воздуха (по обобщению исследований управляемого культивирования - примерно 50-90 % [33]) при наблюдавшихся в боксе 28-29 % заведомо не достигается, что и выражается хронически высоким VPD. Физическая причина хронически высокого дефицита связана с режимом вентиляции: в весенний период приток подает наружный воздух с низким влагосодержанием, который при нагреве в боксе дает низкую относительную влажность и, как следствие, высокий VPD. То есть высокий дефицит - не только следствие недостаточной мощности увлажнителей, но и прямое следствие интенсивного воздухообмена сухим воздухом.
...
Чтобы убедиться, что эта закономерность не случайна, для товарной массы листа выполнен двухфакторный дисперсионный анализ (факторы - световой вариант и сорт; 140 растений, по 3-5 повторностей в ячейке). Влияние светового варианта высоко значимо: $F(4{,}110) = 20{,}4$ при $p < 10^{-11}$; значимы также влияние сорта ($F(5{,}110) = 10{,}6$, $p < 10^{-7}$) и их взаимодействие ($F(20{,}110) = 2{,}2$, $p = 0{,}005$). Следовательно, зависимость урожая от дозы света статистически достоверна. Однако апостериорное попарное сравнение вариантов по критерию Тьюки (наименьшая значимая разность HSD $\approx 24$ г при $p < 0{,}05$) показывает, что достоверно отличается только вариант 1 от всех остальных (прирост 52-72 г), тогда как варианты 2-5 между собой статистически неразличимы (попарные разности 4-20 г не превышают НСР). Средняя товарная масса по вариантам с 95-процентными доверительными интервалами составляет $33{,}8 \pm 12{,}2$; $89{,}9 \pm 12{,}2$; $85{,}6 \pm 12{,}2$; $105{,}6 \pm 12{,}2$ и $93{,}8 \pm 12{,}2$ г соответственно, и интервалы вариантов 2-5 взаимно перекрываются. Это статистически подтверждает вывод о насыщении: дополнительный свет сверх DLI $\approx 6$ моль/(м²·сут) достоверного прироста урожая не дает. В терминах световой кривой фотосинтеза [33] вариант 2 уже выводит культуру на ее пологий участок (плато), где наклон кривой - эффективность использования лучистой энергии - близок к нулю; при этом из всей поглощенной фотосинтетически активной радиации лишь около 5 % расходуется на фотосинтез, а основная часть переходит в тепло и затраты на транспирацию [33], поэтому избыточная облученность увеличивает тепловую и влажностную нагрузку на бокс, не наращивая биомассу.

Из этого прямо следует вывод об энергоэффективности. Удельный выход товарной массы на ватт установленной мощности максимален у варианта 2 (0,93 г/Вт при мощности всего 97 Вт) и монотонно падает к варианту 5 (0,20 г/Вт при 478 Вт), то есть различается в 4-5 раз. Выход на единицу световой дозы у варианта 2 также наибольший (около 14,6 против 5,9 г на моль/(м²·сут) у варианта 5). Отдельно необходимо методически разграничить два показателя светоотдачи, поскольку их смешение ведет к ошибочной оценке светильников. Отношение PPFD к электрической мощности (от $\approx 0{,}98$ у варианта 2 до $\approx 0{,}51$ (мкмоль·м$^{-2}$·с$^{-1}$)/Вт у варианта 5) характеризует фотонную облученность на уровне растений, отнесенную к ваттам, и не равно фотонной отдаче (КПД) светильника $\eta_{\text{ф}}$ в мкмоль/Дж: последняя определяется по полному потоку фотонов PPF, а не по облученности PPFD в отдельной точке. Связь между ними выражается через освещаемую площадь $A$: $\eta_{\text{ф}} = \mathrm{PPFD}\cdot A / P$. Поэтому прямое сравнение отношения PPFD/Вт (0,5-1,0) с каталожной отдачей современных фитосветильников (1,5-2,5 мкмоль/Дж) методически некорректно - это сопоставление поверхностной облученности с полным потоком. При характерной освещаемой площади яруса порядка 1-2 м² расчетная отдача панелей варианта 2 составляет ориентировочно 1-2 мкмоль/Дж, то есть приближается к современному уровню, а не уступает ему в 3-4 раза. Точная площадь облучения в опыте не измерялась, поэтому абсолютное значение $\eta_{\text{ф}}$ приводится оценочно (см. ограничения, подраздел 3.13). Энергетически и агрономически значимым показателем, не зависящим от этой неопределенности, остается удельный выход товарной массы - г/Вт и г на моль DLI; именно он, а не каталожный КПД светильника, определяет экономику освещения. По этому показателю на верхних ступенях мощности возникает проигрыш: растение перестает использовать избыточный свет (плато урожая), поэтому удельная эффективность падает. Кривая «доза света - урожай» с 95-процентными доверительными интервалами и удельная энергоэффективность вариантов показаны на рисунке 3.9.

![Рисунок 3.9 – Зависимость урожая (линия) и энергоэффективности (столбцы) от световой дозы DLI](figures/chart_light_yield.pdf)

С ростом освещенности меняется и качество продукции, причем эти связи, в отличие от покорторных, вычислены по всем 30 ячейкам опыта и статистически достоверны. Содержание сухого вещества листа растет с 5,2 % (вариант 1) до 7,9 % (вариант 5) при значимой корреляции с DLI ($r = +0{,}55$, $p = 0{,}002$, $n = 30$) - лист становится более плотным. Содержание нитратов, напротив, устойчиво снижается ($r = -0{,}62$, $p < 0{,}001$; относительное снижение примерно на 74 % от варианта 1 к варианту 5), что благоприятно с точки зрения пищевого качества. Одновременно при максимальном свете уменьшается доля товарной массы: с 82,9 % в варианте 1 до 62,4 % в варианте 5 ($r = -0{,}38$, $p = 0{,}04$), что указывает на рост доли поврежденных или некондиционных листьев, вероятно усиленный высоким VPD. Сводка по вариантам приведена в таблице 3.6.
...
Отклик на свет различается по сортам и органам растения. Сильную положительную связь урожая с DLI показали сорта Каскад, Риф, Триплекс и Рафаэль (коэффициенты корреляции 0,71-0,79), тогда как сорта Джипси и Цезарь оказались практически свето-нейтральными (корреляция около 0 и отрицательная), то есть их выгоднее выращивать на низких ступенях освещения. Здесь, однако, необходимо подчеркнуть статистическое ограничение, прямо связанное с малым объемом выборки: каждая такая покорторная корреляция построена всего по пяти световым вариантам ($n = 5$), для которых критическое значение коэффициента при $p = 0{,}05$ равно $0{,}878$. Поэтому даже наибольшее значение $r = 0{,}79$ соответствует $p \approx 0{,}11$ и формально не достигает уровня значимости. Покорторные коэффициенты следует трактовать как согласованные описательные тренды, а не как доказанную для каждого отдельного сорта зависимость; статистически достоверным является именно усредненный по сортам эффект света, подтвержденный дисперсионным анализом выше. Напротив, связи, вычисленные по всем 30 ячейкам опыта, достоверны: наиболее светозависимой оказалась масса корня ($r = +0{,}77$, $p < 10^{-6}$), а высота розетки с ростом света значимо снижается ($r = -0{,}47$, $p = 0{,}009$) - при недостатке освещения растения вытягиваются (этиоляция). Отмечена также устойчивая отрицательная связь электропроводности раствора (EC) с высотой растений в пределах каждой даты замера (корреляция от -0,70 до -0,85), что характерно для солевого угнетения роста; при этом EC по ходу опыта дрейфовал вверх (примерно с 2,2 до 3,2 мСм/см).

Таким образом, главный агрономический вывод - насыщение урожая по дозе света и преимущество умеренных режимов - опирается на статистически достоверный результат дисперсионного анализа (эффект варианта $p < 10^{-11}$) и на значимые корреляции качества по выборке $n = 30$. Покорторные же различия и отдельные парные коэффициенты получены на малых выборках и физиологически непротиворечивы, но не являются строгим факторным доказательством, поэтому используются как обоснование гипотез для последующего controlled experiment, а не как окончательная сортовая рекомендация. Это разграничение достоверного и описательного и есть корректная статистическая трактовка наблюдательного эксперимента небольшого объема.
...
5. Ночной режим. Текущая автоматика не выполняет переключений ночью; для культур и сезонов, где это важно, следует добавить ночное регулирование температуры и влажности. По данным исследований управляемого культивирования, для многих культур благоприятен термопериодизм - ночная температура на 5-10 °C ниже дневной [33]; агрономически это согласуется с теплотехническим выводом о допустимом ночном снижении уставок нагрева (подраздел 3.12) и дает дополнительный резерв энергосбережения по доминирующей статье - нагреву.
